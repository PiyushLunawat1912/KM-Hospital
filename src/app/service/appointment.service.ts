...
export class AppointmentService {
  private apiUrl = 'https://km-backend-y9hq.onrender.com/api/appointments'; // Ensure this matches your backend
  ...
  getAllAppointments(): Observable<any> {
    return this.http.get('https://km-backend-y9hq.onrender.com/api/manage-appointments');
  }
